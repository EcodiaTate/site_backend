...
def get_youth_stats(user_id: str, s: Session = Depends(session_dep)):
    ...
    WITH u, total_eco, eco_from_missions, eco_from_eco_local, last_earn_at,
    ...
    RETURN {
      ...
      eco_from_eco_local: toInteger(eco_from_eco_local),
...
def list_youth_stats(
    ...
    CALL {
      ...
      RETURN u.id AS user_id,
             ...
             toInteger(eco_from_eco_local) AS eco_from_eco_local,
