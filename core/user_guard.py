...
async def current_user_id(
    ...
    eco_local_user_token: Optional[str] = Cookie(default=None),
    ...
    3) Cookie eco_local_user_token              (HttpOnly user cookie)
    ...
    if eco_local_user_token:
        return eco_local_user_token
